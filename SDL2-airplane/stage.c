...
static void initPlayer()
{
    ...
    player->y = 100;
    player->health = 1;
    player->texture = loadTexture("picture/player.png");
...
static void addPoints(int x, int y)
{
    ...
    SDL_QueryTexture(pointsTexture, NULL, NULL, &e->w, &e->h);
...
static void drawPointsPds(void)
{
    struct Entity * e;
...
void initStage(void)
{
    ...
    alienBulletTexture = loadTexture("picture/bullet.png");
    bulletTexture = loadTexture("picture/bullet.png");
    enemyTexture = loadTexture("picture/enemy.png");
    pointsTexture = loadTexture("picture/points.png");

    explosionTexture = loadTexture("picture/explosion.png");
